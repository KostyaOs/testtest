...
finalThresholds = []    # list to filled with final thresholds
specimenInfo = pd.read_csv('specimenInfo.csv')  # open specimen info

# make lists, each filled with files of norms of specific group
ChorionFemale = []
FibroblastFemale = []
Male = []
...
for group in groups:
    ...
    finalThresholds.append(max(thresholds))

# write txt with thresholds
with open(output_path + '/finalThresholds.csv', 'wt') as data_file:
