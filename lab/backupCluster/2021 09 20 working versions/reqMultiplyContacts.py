...
def workerPoly(inpath, outpath, dictionarY):
    ...
    # deal with autosomes
    for i in range(1, 23):  # range(1, 23) is [1, ... , 22]
    ...
    if file.endswith(".cool"):  # if file is '.cool' file
        ...
        if patho == 'none':     # if specimen is a norm
            ...
            if patho == 'polyploidy':
                ...
                # get list of aneuploidies
                listing = []
                aneuCounter(patho, listing)     # fill the list
                listing = listing[::-1]
                ...
                while j + 1 <= len(listing):
                    ...
                    if listing[j][0] == '+':
                        ...
                        print(colored('encountered unexpected aneuploidy for specimen ' + specimen, 'red'))
                        exit()
